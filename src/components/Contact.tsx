      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="font-[var(--font-heading)] text-3xl md:text-4xl font-bold text-white tracking-[0.15em] uppercase mb-4">
            Join Us in Building
            <br />
            <span className="text-[#D4A843]">A New Era of Science</span>
          </h2>
        ...
        {!submitted ? (
          <form onSubmit={handleSubmit} className="bg-white/10 backdrop-blur-sm rounded-sm p-8 md:p-10 space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-sm text-white placeholder-white/40 focus:outline-none focus:border-[#D4A843] transition-colors font-[var(--font-body)]"
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-sm text-white focus:outline-none focus:border-[#D4A843] transition-colors font-[var(--font-body)] [&>option]:text-gray-900"
                >
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-sm text-white placeholder-white/40 focus:outline-none focus:border-[#D4A843] transition-colors font-[var(--font-body)] resize-none"
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
              <button
                type="submit"
                disabled={submitting}
                className="w-full sm:w-auto px-10 py-4 bg-[#D4A843] text-white font-[var(--font-heading)] font-bold text-lg tracking-wide uppercase rounded-sm hover:bg-[#E8C97A] hover:text-[#3D1A78] transition-all duration-300 disabled:opacity-50"
              >
              ...
              <a
                ...
                target="_blank"
                className="text-[#D4A843] font-[var(--font-heading)] text-sm tracking-wide uppercase hover:text-white transition-colors flex items-center gap-2"
              >
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-sm p-12 text-center">
            <div className="w-16 h-16 bg-[#D4A843] rounded-full flex items-center justify-center mx-auto mb-6">
        ...
        <div className="mt-12 text-center">
          ...
          <a
            ...
            className="font-[var(--font-heading)] text-[#D4A843] text-lg hover:text-white transition-colors"
          >
